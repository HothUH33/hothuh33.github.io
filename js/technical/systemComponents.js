var systemComponents = {
	...
	'overlay-head': {
		...
		<br>
		<span v-if="player.points.lt('1e1000')"  class="overlayThing">You have spent</span>
		<h2  class="overlayThing" id="points">{{formatWhole(player.points.ceil())}}</h2>
		<span v-if="player.points.lt('1e1e6')"  class="overlayThing"> {{modInfo.pointsName}} in lobby</span>
		<br>
